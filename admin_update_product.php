...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$name',stock = '$stock' , details = '$details', price = '$price' WHERE id = '$update_p_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="number" class="box" value="<?php echo $fetch_products['stock']; ?>" required placeholder="update product stock" name="stock">
   <input type="number" min="1" class="box" value="<?php echo $fetch_products['price']; ?>" required placeholder="update product price" name="price">
