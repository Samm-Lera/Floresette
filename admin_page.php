...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php
            $select_messages = mysqli_query($conn, "SELECT SUM(total_price) AS net_total FROM orders WHERE DATE(placed_on) = CURDATE()") or die('query failed');
            $todays_sale = mysqli_fetch_assoc($select_messages);
         ?>
         <h3><?php echo $todays_sale['net_total'] ?></h3>
         <p>Today's Sale</p>
      </div>
